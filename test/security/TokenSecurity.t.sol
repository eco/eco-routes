...
contract TokenSecurityTest is BaseTest {
    ...
    function testMaliciousTokenInRouteTokens() public {
        ...
        vm.expectRevert();
        inbox.fulfill(destIntent.route, rewardHash, bytes32(uint256(uint160(attacker))), intentHash, address(0));
    }
    ...
    function testMixedTokenStandards() public {
        ...
        assertEq(usdt.balanceOf(claimant), initialClaimantBalanceUSDT + MINT_AMOUNT);
