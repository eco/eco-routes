...
contract EVMDepositAddressTest is Test {
    EVMDepositFactory public factory;
    EVMDepositAddress public depositAddress;
    ...
    function test_initialize_revertsIfNotCalledByFactory() public {
        ...
        EVMDepositAddress implementation = new EVMDepositAddress();
    ...
    function test_createIntent_revertsIfNotInitialized() public {
        ...
        EVMDepositAddress uninit = new EVMDepositAddress();

        vm.expectRevert(EVMDepositAddress.NotInitialized.selector);
        uninit.createIntent(1000);
    }

    function test_createIntent_revertsIfZeroAmount() public {
        vm.expectRevert(EVMDepositAddress.ZeroAmount.selector);
    ...
    function test_createIntent_revertsIfInsufficientBalance() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                EVMDepositAddress.InsufficientBalance.selector,
                1000,
                0
            )
        );
    ...
    function test_refund_isPermissionless() public {
        ...
        vm.expectRevert();
        depositAddress.refund(bytes32(0), reward);
    }

    // ============ Intent Structure Tests ============

    function test_createIntent_constructsRouteCorrectly() public {
        uint256 amount = 1000 ether;
        token.mint(address(depositAddress), amount);
        ...
        // The Route construction is tested implicitly by successful intent creation
        assertTrue(intentHash != bytes32(0));
    }
