...
describe('Intent Source Test', (): void => {
  ...
  describe('claiming rewards', async () => {
    ...
    context('before expiry, proof', () => {
      ...
      it('allows refund if already claimed', async () => {
        ...
        await expect(
          intentSource.connect(otherPerson).refundIntent(routeHash, reward),
        )
    ...
    context('after expiry, no proof', () => {
      ...
      it('gets refunded to creator', async () => {
        ...
        await intentSource.connect(otherPerson).refundIntent(routeHash, reward)
  ...
  describe('funding intents', async () => {
    ...
    it('should fund intent with single token', async () => {
      ...
      await intentSource
        .connect(creator)
        .fundIntent(routeHash, reward, creator.address, ZeroAddress, false)
    ...
    it('should handle partial funding based on allowance', async () => {
      ...
      await intentSource
        .connect(creator)
        .fundIntent(routeHash, reward, creator.address, ZeroAddress, true)
