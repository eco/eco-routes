...
export const CONTRACT_TYPES = ['Portal', 'HyperProver', 'MetaProver'] as const
...
function generateIndexFile(
  ...
  // Use the zero address as a fallback for missing contract addresses
  Object.values(addresses).forEach((contracts) => {
    for (const contractType of CONTRACT_TYPES) {
      contracts[contractType] = contracts[contractType] || zeroAddress
    }
  })
