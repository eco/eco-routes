 ...
 */
export function extractStructsFromAbi(abi: readonly any[]): StructExtractionResult {
 ...
 */
function extractStructFromParameter(param: any, structs: Record<string, ExtractedStruct>): void {
 ...
 */
export function findStruct(structs: Record<string, ExtractedStruct>, structName: string): AbiParameter | null {
 ...
 */
export function generateTypeDefinitions(structs: Record<string, ExtractedStruct>, contractName: string): string {
 ...
 */
export function generateHashUtilities(structs: Record<string, ExtractedStruct>, contractName: string): string {
  // No imports here - they'll be handled at the file level
 ...
 */
export function generateModelClasses(structs: Record<string, ExtractedStruct>, contractName: string): string {
  // No imports here - they'll be handled at the file level
  let modelCode = ``;
