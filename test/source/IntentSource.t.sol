...
contract IntentSourceTest is BaseTest {
    ...
    function testRevertWhen_PublishingWithWrongSourceChain() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IBaseSource.WrongSourceChain.selector, intentHash));
    ...
    function testChallengesIntentProofOnWrongDestinationChain() public {
        ...
        assertEq(prover.hashOfChallengedIntent(), bytes32(0));
        ...
        assertEq(prover.hashOfChallengedIntent(), intentHash);
        assertTrue(intentSource.isIntentFunded(intent));
    }
    
    function testAllowsRefundIfDestinationChainWrong() public {
        _publishAndFund(intent, false);
    ...
    function testBatchWithdrawalFailsBeforeExpiry() public {
        ...
        vm.expectRevert();
        vm.prank(otherPerson);
        intentSource.batchWithdraw(intents);
    }
    ...
    function testHandlesPartialFundingBasedOnAllowance() public {
        ...
        vm.prank(creator);
        tokenB.approve(address(intentSource), MINT_AMOUNT * 2);
    ...
    function testRevertWhenBalanceAndAllowanceInsufficientWithoutAllowPartial() public {
        uint256 requestedAmount = MINT_AMOUNT * 2;
    ...
    function testFakePermitContractHandling() public {
        ...
        vm.expectRevert();
        vm.prank(creator);
        intentSource.fundFor(routeHash, reward, creator, address(fakePermit), false);
